...
class Updater:
    ...
    def __init__(self, market_config=MARKET_CONFIG,
                 huobi_config=HUOBI_CONFIG, watchdog_threshold=3,
                 db_api = None):
        ...
        while self.live:
            ...
            if tick >= 5:
                ...
                try:
                    ...
                    self.db_api.update(trade_name, [timestamp,
                                                    kline[0].count,
                                                    kline[0].open,
                                                    kline[0].close,
                                                    kline[0].low,
...
def main():
    ...
    while True:
        try:
            ...
            ECHO.print("{} keyboard interrupt received, stopping...")
            updater.stop()
            sys.exit(0)
